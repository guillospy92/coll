...
<div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i>editando al curso con el nombre:
         {!!$curso->nombre!!} </h2>
        ...
        <div class="box-inner">
            ...
            <div class="box-content">
                {!! Form::model($curso,['route' => ['cursos.update',$curso], 'method'=>'PUT']  )!!}
                    ...
                    <div class="form-group">
                        {!!Form::label('inputEmail3', 'Cupos', array('class' => ''),array('for' => 'exampleInputEmail1'), array('placeholder' => 'nombre'))!!}
                    {!!Form::text('cupos', null,['class'=>'form-control', 'placeholder'=>'Cupos'])!!}
                    </div>
