...
<div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i>editando al profesor con el nombre:
         {!!$profesor->nombre!!} </h2>
            ...
            <div class="box-content">
                {!! Form::model($profesor,['route' => ['profesores.update',$profesor], 'method'=>'PUT']  )!!}
                     ...
                     <div class="form-group">
                        {!!Form::label('inputEmail3', 'Cedula', array('class' => ''),array('for' => 'exampleInputEmail1'), array('placeholder' => 'nombre'))!!}
                    {!!Form::text('cedula', null,['class'=>'form-control', 'placeholder'=>'Cedula CC'])!!}
                    </div>
                    ...
                    <div class="form-group">
                        {!!Form::label('inputEmail3', 'cargo', array('class' => ''),array('for' => 'exampleInputEmail1'), array('placeholder' => 'nombre'))!!}
                    {!!Form::text('cargo', null,['class'=>'form-control', 'placeholder'=>'Cargo'])!!}
                    </div>
                    <div class="form-group">
                        {!!Form::label('inputEmail3', 'dirrecion', array('class' => ''),array('for' => 'exampleInputEmail1'), array('placeholder' => 'nombre'))!!}
                    {!!Form::text('direcion', null,['class'=>'form-control', 'placeholder'=>'Dirrecion'])!!}
                    </div>

                    <div class="form-group">
                        {!!Form::label('inputEmail3', 'Telefono', array('class' => ''),array('for' => 'exampleInputEmail1'), array('placeholder' => 'nombre'))!!}
                    {!!Form::text('telefono', null,['class'=>'form-control', 'placeholder'=>'Cargo'])!!}
                    </div>
